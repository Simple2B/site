"""check connect to new orm

Revision ID: 721d5c87bd18
Revises: 3a1be7ab8d57
Create Date: 2023-08-01 18:50:08.443621
...
def upgrade():
    ...
    sa.Column('main_image_id', sa.Integer(), nullable=False),
    sa.Column('full_main_image_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['full_main_image_id'], ['case_images.id'], name=op.f('fk_cases_full_main_image_id_case_images')),
    sa.ForeignKeyConstraint(['main_image_id'], ['case_images.id'], name=op.f('fk_cases_main_image_id_case_images')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_cases')),
    sa.UniqueConstraint('title', name=op.f('uq_cases_title'))
    )
    op.create_table('case_screenshots',
    sa.Column('case_id', sa.Integer(), nullable=False),
    sa.Column('description', sa.String(length=256), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('url', sa.String(length=256), nullable=False),
    sa.Column('origin_file_name', sa.String(length=256), nullable=False),
    sa.ForeignKeyConstraint(['case_id'], ['cases.id'], name=op.f('fk_case_screenshots_case_id_cases')),
