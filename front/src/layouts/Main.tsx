...
export const MainLayout: React.FC<IMainLayoutProps> = ({ children, title = 'Page' }) => {
    ...
    <>
      ...
      >
        <Head>
          ...
          <meta property='og:image' content={`https://www.simple2b.net/png/logo.png`} />
          <meta name='twitter:image' content={`https://www.simple2b.net/png/logo.png`} />
