...
def create_test_superuser_and_candidate(db, test_data) -> tuple[m.SuperUser, m.Candidate]:
    ...
    candidate = m.Candidate(git_hub_id=test_data.test_candidate.git_hub_id,email=test_data.test_candidate.email, username=test_data.test_candidate.username)
    db.add(
        superuser
    )
    db.add(candidate)
