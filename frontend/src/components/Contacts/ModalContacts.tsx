      ...
      <div className={classes.contacts__content}>
        <div className={classes.contacts__address_wrapper}>
          <address className={classes.contacts__address}>
            ...
            {<ContactLink link={email.link} text={email.text} bold />} or call on number{' '}
            {<ContactLink link={phone.link} text={phone.text} bold />}
            . <br />
          </address>
          <span className={clsx(classes.contacts__image, classes.contacts__image_side)}>
            <Image
        ...
        <span className={clsx(classes.contacts__image, classes.contacts__image_bottom)}>
          <Image
            src={`/svg/bees/magnet.svg`}
            alt={`Contact us. Bee with magnet :-)`}
            layout='fill'
